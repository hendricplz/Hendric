'''
4. Escreva uma função que receba um número inteiro e mostre o mês correspondente ao

número. Por exemplo, 3 corresponde à “março”. O procedimento deve mostrar uma mensagem
